...
window.GWMS_COURSE_BUNDLE["session-07"] =
{
  ...
  "meta": {
    ...
    "takeaway": "Losing cracks the mask, and what comes out is information, not failure.",
          ...
          "reveals": [
            {
              ...
              "content": [
                {
                  "kind": "paragraph",
                  "text": "Everybody wears a face for the crowd, and now yours has a name."
                }
              ]
            }
          ]
      ...
      "slides": [
        {
          ...
          "body": [
            {
              "kind": "lead",
              "text": "Apply base and framing while under a passing attempt as the guard is beaten."
            },
            {
              "kind": "heading",
              "level": 3,

...
window.GWMS_COURSE_BUNDLE["session-15"] =
{
  ...
  "meta": {
    ...
    "looksBackAt": 3,
    "grapplingElos": [
      "Enter and secure a chest pin from a neutral position.",
      "Keep control without abandoning the position when it gets hard."
    ],
    "caselTlo": "By the end of this session, the participant will describe who they are with other people now that the Descent named the real self.",
    "caselElos": [
      ...
      "slides": [
        {
          "id": "s15-question",
          "type": "text-image",
          "eyebrow": "Session 15 · Probing question",
          ...
          "body": [
            ...
            },
            {
              ...
              "text": "Session 15 of 36. The Initiation, Week 5, Contact. On the mat that stage runs Chest Pin."
            }
          ],
          "alternates": [
            {

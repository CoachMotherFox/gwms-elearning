...
window.GWMS_COURSE_BUNDLE["session-16"] =
{
  "id": "session-16",
  "title": "Session 16 — Friction",
  "lang": "en",
  ...
  "scenes": [
    {
      ...
      "slides": [
        ...
        },
        {
          "id": "s16-lookback",
          "eyebrow": "Look back",
          "title": "Session 13 asked you this",
          "body": [
            {
              "kind": "quote",
              "text": "What happens in you when someone makes real contact?",
              "attribution": "Session 13 — The Initiation, Contact"
            },
            {
              "kind": "paragraph",
        ...
        },
        {
          ...
          "type": "text-image",
          "eyebrow": "The game",
          "title": "Mounted and Side Control Pin Game",
          "body": [
            {
              "kind": "lead",
        ...
        },
        {
          ...
          "question": "In Mounted and Side Control Pin Game, what counts as the win?",
          "select": "single",
          "retry": true,
          "options": [
            {
    ...
    },
    {
      ...
      "slides": [
        ...
        },
        {
          ...
          "submit": true,
          "sendLabel": "Send it",
          "reflectionFrom": "s16-reflection",
          "body": [
            {
              "kind": "callout",
              "label": "Next session",
              "text": "Session 17: Can you stay present when it gets uncomfortable?"
            }
          ],

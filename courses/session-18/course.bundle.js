...
window.GWMS_COURSE_BUNDLE["session-18"] =
{
  "id": "session-18",
  "title": "Session 18 — Friction",
  "lang": "en",
  ...
  "meta": {
    ...
    "card": "The Chest Pin",
    "domain": "Control",
    "keyCondition": "Firm control that keeps the partner safe, adjust to the tap.",
    "probingQuestion": "What does your friction do to the people across from you?",
    "grapplingTlo": "By the end of this session, the participant will apply chest-pin control at an intensity that keeps the partner safe, controlling their own force deliberately.",
    "grapplingElos": [
      "Apply the pin firmly while keeping the partner safe.",
      "Adjust intensity based on the partner's signals and taps."
    ],
    "caselTlo": "By the end of this session, the participant will name the effect their conflict style has on other people and one adjustment they can make.",
    "caselElos": [
      ...
      "slides": [
        {
          "id": "s18-question",
          "type": "text-image",
          "eyebrow": "Session 18 · Probing question",
        ...
        },
        {
          ...
          "type": "text-image",
          "eyebrow": "The game",
          "title": "Hip Control Breakdown Game",
          "body": [
            {
              "kind": "lead",
        ...
        },
        {
          ...
          "question": "In Hip Control Breakdown Game, what counts as the win?",
          "select": "single",
          "retry": true,
          "options": [
            {

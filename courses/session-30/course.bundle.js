...
window.GWMS_COURSE_BUNDLE["session-30"] =
{
  "id": "session-30",
  "title": "Session 30 — Contribution",
  "lang": "en",
      ...
      "slides": [
        {
          ...
          "body": [
            {
              "kind": "lead",
              "text": "By the end of this session, the participant will apply dominant back-pin control without hurting the partner, and analyze the choice to control without harm."
            },
            {
              "kind": "heading",
              "level": 3,
        ...
        },
        {
          ...
          "body": [
            {
              "kind": "lead",
              "text": "By the end of this session, the participant will name how they use their strength in service rather than over others."
            },
            {
              "kind": "heading",
              "level": 3,
    ...
    },
    {
      ...
      "slides": [
        ...
        },
        {
          ...
          "submit": true,
          "sendLabel": "Send it",
          "reflectionFrom": "s30-reflection",
          "body": [
            {
              "kind": "callout",
              "label": "Next session",
              "text": "Session 31: What do you want to leave behind you here?"
            }
          ],

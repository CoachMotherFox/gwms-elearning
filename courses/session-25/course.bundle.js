...
window.GWMS_COURSE_BUNDLE["session-25"] =
{
  "id": "session-25",
  "title": "Session 25 — Emergence",
  "lang": "en",
  ...
  "scenes": [
    {
      ...
      "slides": [
        ...
        },
        {
          "id": "s25-lookback",
          "eyebrow": "Look back",
          "title": "Session 22 asked you this",
          "body": [
            {
              "kind": "quote",
              "text": "What does it take for you to say sorry and mean it?",
              "attribution": "Session 22 — The Initiation, Repair"
            },
            {
              "kind": "paragraph",
        ...
        },
        {
          ...
          "question": "In Back Take, Maintain Chest to Back Contact, what counts as the win?",
          "select": "single",
          "retry": true,
          "options": [
            {

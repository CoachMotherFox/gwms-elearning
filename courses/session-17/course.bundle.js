...
window.GWMS_COURSE_BUNDLE["session-17"] =
{
  ...
  "meta": {
    ...
    "looksBackAt": 11,
    "grapplingElos": [
      "Remain in a difficult chest-pin position, being framed and bridged, for a set time without disengaging.",
      "Use a regulation tool, breath or base reset, to stay present under pressure."
    ],
    "caselTlo": "By the end of this session, the participant will practice staying present in discomfort and name what makes them want to bail.",
    "caselElos": [
      ...
      "slides": [
        {
          "id": "s17-question",
          "type": "text-image",
          "eyebrow": "Session 17 · Probing question",
        ...
        },
        {
          ...
          "body": [
            ...
            },
            {
              ...
              "text": "Staying is the skill, but leaving a harmful situation is wisdom, not failure."
            }
          ],
          "reveals": [
            {
